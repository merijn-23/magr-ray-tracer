...
public:
	Scene()
	{
		...
		mats[4] = Material{ float4(1, 1, 1, 0), 0, 1, 1.1f, true };
		mats[5] = Material{ float4(0, 1, 0, 0), 0, 0, 0, false };
		mats[6] = Material{ float4(0, 0, 1, 0), 0, 0, 0, false };
		mats[7] = Material{ float4(1, 1, .5f, 0), 0, 0, 0, false };

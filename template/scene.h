...
public:
	Scene()
	{
		...
		mats[0] = Material{ float4(1, 0, 0, 0), 0, 0 };
		prims[0] = Primitive{ 0, 0, 0 };
		prims[1] = Primitive{ 0, 1, 0 };
		...
		prims[2] = Primitive{ 1, 0, 0 };
		prims[3] = Primitive{ 1, 1, 0 };
		prims[4] = Primitive{ 1, 2, 0 };
		prims[5] = Primitive{ 1, 3, 0 };
		prims[6] = Primitive{ 1, 4, 0 };

		lights[0] = Light{ float4(2, 0, 3, 0), float4(1,1,1,0), 3, -1 };
		//prims[6] = Primitive{ 1, 4, 0 };
